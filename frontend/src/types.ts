...
export const slashCommands: SlashCommand[] = [
    ...
    { label: '引用版本方案 v0.1.0', icon: '📑', desc: 'docs://versions/v0.1.0-controlled-version-plan-to-tasklist-agent.md', alias: ['version', '版本', 'v0.1'],
      action: (ed) => { ed.insertDocReference('docs://versions/v0.1.0-controlled-version-plan-to-tasklist-agent.md'); } },
...
export const atReferences: AtReference[] = [
    ...
    { label: 'docs://versions/v0.1.0-controlled-version-plan-to-tasklist-agent.md', type: 'doc', desc: '版本方案 v0.1.0 (完整名)', keywords: ['version', '版本', 'v0.1', 'tasklist', 'agent', 'plan'] },
